/**
 * Created by Saidmurod Turdiyev (S.M.T) on 3/6/2023 11:11 PM for Fitnes.
 */
object Versions {
    ...
    const val accompanist_systemuicontroller="0.29.2-rc"

    //lottie
    const val lottie_compose="5.0.3"
}
...
object Lottie{
    const val compose="com.airbnb.android:lottie-compose:${Versions.lottie_compose}"
}
